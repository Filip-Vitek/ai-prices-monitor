{
  "checked_at_utc": "2026-07-22T23:01:56Z",
  "model_count": 330,
  "models": {
    ...
    "dashscope::qwen-max": {
      "input_usd_per_1m": 1.6,
      "model": "qwen-max",
      "output_usd_per_1m": 6.4,
      "provider": "Alibaba (Qwen)",
      "region": "China",
      "source": "community"
    },
    ...
    "dashscope::qwen3-vl-32b-instruct": {
      "input_usd_per_1m": 0.16,
      "model": "qwen3-vl-32b-instruct",
      "output_usd_per_1m": 0.64,
      "provider": "Alibaba (Qwen)",
      "region": "China",
      "source": "community"
    },
    ...
    "gemini::gemini-gemma-2-27b-it": {
      "input_usd_per_1m": 0.35,
      "model": "gemini-gemma-2-27b-it",
      "output_usd_per_1m": 1.05,
      "provider": "Google (Gemini)",
      "region": "USA",
      "source": "community"
    },
    ...
    "openai::gpt-5.2-pro": {
      "input_usd_per_1m": 21.0,
      "model": "gpt-5.2-pro",
      "output_usd_per_1m": 168.0,
      "provider": "OpenAI",
      "region": "USA",
      "source": "community"
    },
    ...
    "openai::o1-pro": {
      "input_usd_per_1m": 150.0,
      "model": "o1-pro",
      "output_usd_per_1m": 600.0,
      "provider": "OpenAI",
      "region": "USA",
      "source": "community"
    },
    ...
    "openai::o3-pro": {
      "input_usd_per_1m": 20.0,
      "model": "o3-pro",
      "output_usd_per_1m": 80.0,
      "provider": "OpenAI",
      "region": "USA",
      "source": "community"
    },
  ...
  "sources": {
    "anthropic": "fallback: community",
    "dashscope": "fallback: community",
    "deepseek": "fallback: community",
    "gemini": "fallback: community",
    "minimax": "fallback: community",
    "mistral": "fallback: community",
    "moonshot": "fallback: community",
    "openai": "fallback: community",
    "xai": "fallback: community",
    "zai": "fallback: community"
  }
}
